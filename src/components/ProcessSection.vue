<template>
  <section id="process" class="py-20 bg-surface">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-surface-elevated rounded-2xl shadow-lg overflow-hidden border border-border">
        <div class="md:flex">
          <div class="md:w-1/2 p-8 md:p-12">
            <h3 class="text-2xl font-bold mb-4 text-foreground">Complete Workflow</h3>
            <ol class="list-decimal pl-5 space-y-4 text-foreground">
              <li>
              ...
              <li>
                ...
                <code class="bg-surface px-2 py-1 rounded border border-border">/examples</code> folder
              </li>
              <li>
              ...
              <li>
                ...
                <code class="bg-surface px-2 py-1 rounded border border-border">npm run dev</code> and try
                <code class="bg-surface px-2 py-1 rounded border border-border">npm run build</code>
              </li>
              <li>
