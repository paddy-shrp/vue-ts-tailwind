    ...
    <div class="max-w-md mx-auto">
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="text-center space-y-2">
                ...
                <p class="text-sm text-gray-600">
                    <router-link to="/auth/forgot-password" class="font-medium text-primary hover:text-primary-dark">
...
const { signIn, signInWithProvider, loading, error: authError } = useAuth()
